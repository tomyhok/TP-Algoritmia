...
def ordenarLista(matrizResumenes):
    ...
    while desordenada:
        ...
        for i in range(len(matrizResumenes)-1):
            if matrizResumenes[i][0] > matrizResumenes[i+1][0]:
                ...
                aux1 = matrizResumenes[i][len(matrizResumenes[0])-1]
                matrizResumenes[i][len(matrizResumenes[0])-1] = matrizResumenes[i+1][len(matrizResumenes[0])-1]
                matrizResumenes[i+1][len(matrizResumenes[0])-1] = aux1
                desordenada = True
    ...
    for i in range(len(matrizResumenes)):
        matrizCostos[i][0]=matrizResumenes[i][len(matrizResumenes[0])-1]
...
def facturacionTipoProducto(cocinaM1,cocinaM2,cocinaM3,heladeraM1,heladeraM2,heladeraM3,aireM1,aireM2,aireM3,lavarropasM1,lavarropasM2,lavarropasM3,microondasM1,microondasM2,microondasM3,precioCocina,precioHeladera,precioAire,precioLavarropas,precioMicroondas,costoCocina,costoHeladera,costoAire,costoLavarropas,costoMicroondas,unidadesCocina,unidadesHeladera,unidadesAire,unidadesLavarropas,unidadesMicroondas):
    ...
    resumenes = [resumenCocinas,resumenHeladeras,resumenAires,resumenLavarropas,resumenMicroondas]
    costosOrdenados=ordenarLista(resumenes)
...
def listadoFacturacion(cocinaM1,cocinaM2,cocinaM3,heladeraM1,heladeraM2,heladeraM3,aireM1,aireM2,aireM3,lavarropasM1,lavarropasM2,lavarropasM3,microondasM1,microondasM2,microondasM3,precioCocina,precioHeladera,precioAire,precioLavarropas,precioMicroondas,costoCocina,costoHeladera,costoAire,costoLavarropas,costoMicroondas):
    ...
    cocinasOrdenadasM1 = [facturacionCocinasM1,facturacionCocinasM1,"Modelo 1: $"]
    cocinasOrdenadasM2 = [facturacionCocinasM2,facturacionCocinasM2,"Modelo 2: $"]
    cocinasOrdenadasM3 = [facturacionCocinasM3,facturacionCocinasM3,"Modelo 3: $"]

    matrizCocinas = [cocinasOrdenadasM1,cocinasOrdenadasM2,cocinasOrdenadasM3]
    cocinasOrdenadas = ordenarLista(matrizCocinas)

    heladerasOrdenadasM1 = [facturacionHeladerasM1,facturacionHeladerasM1,"Modelo 1: $"]
    heladerasOrdenadasM2 = [facturacionHeladerasM2,facturacionHeladerasM2,"Modelo 2: $"]
    heladerasOrdenadasM3 = [facturacionHeladerasM3,facturacionHeladerasM3,"Modelo 3: $"]

    matrizHeladeras = [heladerasOrdenadasM1,heladerasOrdenadasM2,heladerasOrdenadasM3]
    heladerasOrdenadas = ordenarLista(matrizHeladeras)
    
    airesOrdenadosM1 = [facturacionAiresM1,facturacionAiresM1,"Modelo 1: $"]
    airesOrdenadosM2 = [facturacionAiresM2,facturacionAiresM2,"Modelo 2: $"]
    airesOrdenadosM3 = [facturacionAiresM3,facturacionAiresM3,"Modelo 3: $"]

    matrizAires = [airesOrdenadosM1,airesOrdenadosM2,airesOrdenadosM3]
    airesOrdenados = ordenarLista(matrizAires)

    lavarropasOrdenadosM1 = [facturacionLavarropasM1,facturacionLavarropasM1,"Modelo 1: $"]
    lavarropasOrdenadosM2 = [facturacionLavarropasM2,facturacionLavarropasM2,"Modelo 2: $"]
    lavarropasOrdenadosM3 = [facturacionLavarropasM3,facturacionLavarropasM3,"Modelo 3: $"]

    matrizLavarropas = [lavarropasOrdenadosM1,lavarropasOrdenadosM2,lavarropasOrdenadosM3]
    lavarropasOrdenados = ordenarLista(matrizLavarropas)

    microondasOrdenadosM1 = [facturacionMicroondasM1,facturacionMicroondasM1,"Modelo 1: $"]
    microondasOrdenadosM2 = [facturacionMicroondasM2,facturacionMicroondasM2,"Modelo 2: $"]
    microondasOrdenadosM3 = [facturacionMicroondasM3,facturacionMicroondasM3,"Modelo 3: $"]

    matrizMicroondas = [microondasOrdenadosM1,microondasOrdenadosM2,microondasOrdenadosM3]
    microondasOrdenados = ordenarLista(matrizMicroondas)
